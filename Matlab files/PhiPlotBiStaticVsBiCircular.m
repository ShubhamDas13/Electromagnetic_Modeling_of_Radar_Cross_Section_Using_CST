...
data = load('PhiPlotBiStaticVsBiCircular.txt');
...
legend('BiStatic Linear Cylinder','BiCircular Cylinder');
% Setting labels
xlabel('Phi (degrees)');
ylabel('RCS (dB(m^2)');

% Chart Title
title('Phi Plot BiStatic Linear vs Bicircular Cylinder (RCS vs Phi )');
